    ...
    <div class="container">
        <div class="navbar-header">
            ...
            <?php elseif($brand_type == 'image') : ?>
                <a class="navbar-brand" href="index.php"><img id="logo" src="<?php echo $brand_image; ?>" /></a>
            <?php endif; ?>
        </div>
        ...
        <div class="dropdown">
            <?php if($profile_type == 'image') : ?>
                <img id="profile" class="dropdown-toggle" data-toggle="dropdown" src="<?php echo $profile_image; ?>" alt="Profile Icon" />
            <?php endif; ?>
            <div class="dropdown-menu dropdown-menu-right">
                <p>Email address</p> <!-- Make Dynamic -->
                <p class="dropdown-divider"></p>
                <p>Name</p> <!-- Make Dynamic -->
                <p>Job Title</p> <!-- Make Dynamic -->
                <p>Department</p> <!-- Make Dynamic -->
                <p class="dropdown-divider"></p>
